...
/**
 * Manage one resource from the administrator area (MPS-REQ-019, MPS-ACC-030).
 *
...
export const metadata: Metadata = {
  title: "Resource — Operations — Home School Haven of SWFL",
}
...
export default async function AdminResourcePage({
  ...
  const viewer = await requireAdmin(
    `/admin/communications/resources/${resourceId}`,
  )
