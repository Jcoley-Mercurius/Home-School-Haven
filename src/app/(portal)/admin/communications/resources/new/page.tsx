...
/**
 * Compose a new resource from the administrator area (MPS-REQ-019).
 *
...
export const metadata: Metadata = {
  title: "New resource — Operations — Home School Haven of SWFL",
}

export default async function NewAdminResourcePage() {
  const viewer = await requireAdmin("/admin/communications/resources/new")
      ...
      >
        ...
        {programs.length === 0 ? (
          <EmptyState title="There are no programs yet">
            <p>
              A resource belongs to a program. Create a program first, then come
              back.
            </p>
          </EmptyState>
        ) : (
