...
| Resend | Server-only transactional delivery and custom SMTP | `INSPECT` — not configured. Blocks self-service account verification (MPS-REQ-011) and therefore Phase 3. |
...
| `NEXT_PUBLIC_SITE_URL` | Canonical application URL for auth redirect construction | Browser, by design |
